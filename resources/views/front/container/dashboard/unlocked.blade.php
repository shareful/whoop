...
@section('content')
		...
		<div class="row">
			<div id="main_carousel_home" class="owl-carousel owl-theme">
				...
				<div class="item">
					...
					<section id="demos2" class="error_3">
						<div class="container">
							<div class="row">
								<div class="large-12 columns">
									<div class="message-wapper"><!-- <span class="icon"><img src="images/error-1-icon.png"></span> -->
										<a href="#" data-toggle="modal" data-target="#byCodeModal"><span class="text">Your <head></head>home's Whoop! Button is now unlocked at <u> 16, Westway, London, SW1 1AW</u></span></a>
									</div>
								</div>
							</div>
						</div>
					...
					<section id="demos2" class="verify_address">
						<div class="container">
							<div class="center-plus">
								<img src="{{ asset('front_assets/images/plus-orange.png') }}">
								<span>Add Photo</span>
							</div>
							<div class="row" id="cuts">
								<div class="col-md-6">
									<div class="unlock-icon-bg">
										<div class="unlock-icon">
											...
											<a href="{{ route('user-verify') }}"><img src="{{ asset('front_assets/images/Unlocked-right.png') }}" alt="" title=""></a>
										</div>
										<div class="unlock-title">Unlocked
											<br>
											<span>Your home's button is unlocked</span>
										</div>
									</div>
								</div>
								<div class="col-md-6">
									<div class="unlock-icon-bg"><!--  invite -->
										<a href="{{ route('user-invite') }}">
											<div class="unlock-icon">
												<img src="{{ asset('front_assets/images/invite-g_orange.png') }}" alt="" title="" style="min-width: 43px;">
											</div>
											<div class="unlock-title">
												<div class="hightlighter_remove">invite</div>
												<span>Invite the people you live with </span>
										...
										<div class="invite_popup hidden invite_popup_home_button">
											...
											<p>You can now invite the people you live with so they can save too. When everyone you live with
												joins the button you'll unlock a reward. </p>
											<div class="arrow-down arrow-down-home-button"></div>
										</div>
									</div>
								</div>
	...
	<div class="modal fade" id="byCodeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h3 class="modal-title" id="exampleModalLabel">Unlocked!</h3>
					<!-- <button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button> -->
				</div>
				<div class="modal-body"><br>
					Your home's button is now unlocked. You can now access all of your home's deals and invite the people you live with. Remember to add a photo to your button so the people you live with know it's you. Tap a profile to start.
				</div>
				<div class="modal-footer">
					<!-- <a href="home-whoop-button-2.html" class="btn btn-default" >Close</a> -->
